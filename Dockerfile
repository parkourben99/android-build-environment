...
ENV ANDROID_COMPONENTS platform-tools,android-24,android-25,build-tools-25.0.2,build-tools-25.0.0,extra-android-m2repository,extra-google-m2repository
